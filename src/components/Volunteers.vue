<template>
  <section
    id="volunteer"
    class="ftco-section ftco-no-pt ftco-no-pb ftco-volunteer"
  >
    <div class="container">
      <div class="row">
        <div
          ...
          <div class="row no-gutters justify-content-end">
            <div class="col-lg-7">
              <div class="text py-5 pl-md-4 pr-md-3">
                ...
                <p>
                  <a href="#" class="btn btn-primary py-3 px-4">Join now</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-5 d-flex align-items-center bg-black">
          <div class="about-text py-5 pl-md-5">
            <h2>
              Member Amount: <strong class="number" data-number="75">0</strong>
            </h2>
            <p>
