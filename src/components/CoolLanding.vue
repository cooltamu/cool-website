  ...
  <div>
    ...
    >
      ...
      <div id="home" class="container">
        ...
        >
          <div
            class="col-md-6 order-md-last ftco-animate mt-5"
          ...
          >
            ...
            <p>
              <a href="#volunteer" class="btn btn-black py-3 px-4"
                >How Can I Help</a
              >
            </p>
          </div>
            ...
            <div class="play-video pb-5 d-flex align-items-center">
              <p>
                <a href="https://vimeo.com/45830194" class="popup-vimeo"
                  ...
                  <span class="play">Play video</span></a
                >
              </p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center pb-3">
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>
              Quotes and thoughts from our community!
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="carousel-causes owl-carousel">
              <div class="item">
                <a
                  data-toggle="modal"
                  data-target="#snapshot1"
                  class="causes text-center"
                >
                  <div
                    class="img"
              ...
              <div class="item">
                ...
                >
                  <div
                    class="img"
                    style="background-image: url(images/causes-2.jpg);"
                  ></div>
                  <h2>Random Mentee</h2>
                </a>
              </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Some text about the quote and a lot of cute fun things yay
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p class="d-none">
              ...
              with <i class="icon-heart color-danger" aria-hidden="true"></i> by
...
.ftco-navbar-light.scrolled {
  ...
  top: 0;
  margin-top: -130px;
  background: #20a29a !important;
  -webkit-box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);
  box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);
}
.ftco-navbar-light.scrolled .nav-item.active > a {
  color: var(--primary) !important;
  text-shadow: 0 0 10px #004541;
}
...
@media (min-width: 768px) {
  ...
  .slider-text .play-video p a {
    color: #fff;
  }
  .slider-text .play-video p .icon {
    font-size: 16px;
    padding-bottom: 10px;
  }
  .slider-text .play-video p .icon i {
    padding: 20px 15px;
    background: #000000;
...
.ftco-volunteer .about-text h2 {
  font-weight: 900;
  font-size: 50px;
  line-height: 1.1;
  color: #fff;
}
.ftco-volunteer .about-text h2 strong,
.ftco-volunteer .about-text h2 span {
  font-weight: 900;
...
.causes:hover .img:after,
.causes:focus .img:after {
  opacity: 0.8;
}
...
.ftco-causes .owl-carousel {
  margin: 0;
}
.ftco-causes .owl-carousel .owl-stage-outer {
  padding-top: 2em;
  padding-bottom: 0;
  position: relative;
}
...
.ftco-causes .owl-nav .owl-prev,
.ftco-causes .owl-nav .owl-next {
  position: absolute;
  width: 60px;
  height: 60px;
  background: #fff !important;
...
.ftco-causes .owl-nav .owl-prev span:before,
.ftco-causes .owl-nav .owl-next span:before {
  font-size: 20px;
  margin-top: 7px;
  color: #000000;
}
...
.ftco-causes .owl-nav .owl-prev:hover,
.ftco-causes .owl-nav .owl-prev:focus {
  background: #000000 !important;
  outline: none !important;
}
.ftco-causes .owl-nav .owl-prev:hover span:before,
.ftco-causes .owl-nav .owl-prev:focus span:before {
  font-size: 20px;
  margin-top: 7px;
  color: #fff;
}
...
.ftco-causes .owl-nav .owl-next:hover,
.ftco-causes .owl-nav .owl-next:focus {
  background: #000000 !important;
  outline: none !important;
}
.ftco-causes .owl-nav .owl-next:hover span:before,
.ftco-causes .owl-nav .owl-next:focus span:before {
  font-size: 24px;
  margin-top: 7px;
  color: #fff;
}
.ftco-causes .owl-dots {
  text-align: center;
}
.ftco-causes .owl-dots .owl-dot {
  width: 10px;
  height: 10px;
  margin: 5px;
  border-radius: 50%;
...
.ftco-causes .owl-dots .owl-dot.active {
  background: var(--primary) !important;
}
...
@-webkit-keyframes pulse {
  0% {
    -webkit-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0.4);
  }
  70% {
    -webkit-box-shadow: 0 0 0 30px rgba(255, 180, 0, 0);
  }
  100% {
    -webkit-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0);
  }
}

@keyframes pulse {
  0% {
    -moz-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0.4);
    -webkit-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0.4);
    box-shadow: 0 0 0 0 rgba(255, 180, 0, 0.4);
  }
  70% {
    -moz-box-shadow: 0 0 0 30px rgba(255, 180, 0, 0);
    -webkit-box-shadow: 0 0 0 30px rgba(255, 180, 0, 0);
    box-shadow: 0 0 0 30px rgba(255, 180, 0, 0);
  }
  100% {
    -moz-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0);
    -webkit-box-shadow: 0 0 0 0 rgba(255, 180, 0, 0);
